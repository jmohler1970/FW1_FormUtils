component {
/*
        Copyright (c) 2009-2013, Sean Corfield, Ryan Cogswell, James Mohler
...
/* this is not the official FW/1 release */
    ...
    // Start Support for Form Utils: JM
    this.objFormUtilities = new formUtilities();
    // End Support for Form Utils: JM
    ...
    private void function setupFrameworkEnvironments() {
        ...
        if ( !request._fw1.requestDefaultsInitialized ) {
            ...
            //Start support for Form Utils 
            if ( isDefined('form') ) structAppend(request.context, this.objFormUtilities.buildFormCollections(form));
            //End support for Form Utils
